...
var sale_schema = mongoose.Schema({transaction_id: 'string', sale_price: 'Number', date_of_sale: 'Date'});
...
sql.open(conn_str, function (err, conn) {
    ...
    conn.queryRaw("SELECT TOP 10 transaction_id, sale_price, date_of_sale FROM Sales", function (err, results) {
        if (err) {
